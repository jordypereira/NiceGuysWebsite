<form method="post" action="{{url('admin/home')}}" enctype="multipart/form-data">
    ...
    <div class="form-group mt-0 mb-4">
        ...
        <div id="accordion1">
            ...
            @else
                <div class="collapse multi-collapse" id="multiCollapseExample1" style="max-height: 46px" data-parent="#accordion1">
                    <div class="alert alert-danger">
                        <p class="m-0">U moet eerst een foto uploaden voor u er een kunt selecteren!</p>
                    </div>
                </div>
            @endif
            <div class="collapse" id="multiCollapseExample2" style="max-height: 64px" data-parent="#accordion1">
